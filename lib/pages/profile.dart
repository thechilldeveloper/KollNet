...
import 'package:KollNet/auth/register/register.dart';
import 'package:KollNet/components/stream_builder_wrapper.dart';
import 'package:KollNet/components/stream_grid_wrapper.dart';
import 'package:KollNet/models/post.dart';
import 'package:KollNet/models/user.dart';
import 'package:KollNet/screens/edit_profile.dart';
import 'package:KollNet/screens/settings.dart';
import 'package:KollNet/utils/firebase.dart';
import 'package:KollNet/widgets/post_tiles.dart';
import 'package:KollNet/widgets/posts_view.dart';
...
class _ProfileState extends State<Profile> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: Text(('KollNet'), style: TextStyle(fontWeight: FontWeight.w900)),
        actions: [
