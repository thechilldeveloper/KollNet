...
import 'package:KollNet/auth/login/login.dart';
import 'package:KollNet/components/password_text_field.dart';
import 'package:KollNet/components/text_form_builder.dart';
import 'package:KollNet/utils/validation.dart';
import 'package:KollNet/view_models/auth/register_view_model.dart';
      ...
      child: Scaffold(
        ...
        body: ListView(
          ...
          children: [
            ...
            Text(
              'Welcome to KollNet..\nCreate a new account and connect with collage friends',
              style: TextStyle(
          ...
          Container(
            ...
            child: ElevatedButton(
              style: ButtonStyle(
                ...
                backgroundColor:
                    MaterialStateProperty.all<Color>(Color(0xfff84646)),
              ),
              child: Text(
                'sign up'.toUpperCase(),
                style: TextStyle(
